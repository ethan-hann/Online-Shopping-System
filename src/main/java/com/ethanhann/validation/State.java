...
/**
 * An enumeration representing the 50 US states
 */
public enum State
{
    ALABAMA("Alabama", "AL"),
    ...
    private static final HashMap<String, State> STATE_ABBREVIATION = new HashMap<>();

    static
    {
        for (State s : values())
        {
            STATE_ABBREVIATION.put(s.getAbbreviation(), s);
        }
    }
    ...
    {
        final State s = STATE_ABBREVIATION.get(abbreviation);
        return Objects.requireNonNullElse(s, UNKNOWN);
    }
